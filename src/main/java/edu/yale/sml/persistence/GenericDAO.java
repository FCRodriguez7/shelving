...
public interface GenericDAO<T> {
    ...
    List<T> findPagedResultByType(Class classz, int first, int last, String orderClause, String type,
                                  String field) throws Throwable;

    List<T> findPagedResultByType(Class classz, int first, int last, String orderClause, String type1,
                                  String field1, String type2, String field2) throws Throwable;
