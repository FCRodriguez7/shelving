...
public final class ShelvingHibernateDAO extends GenericHibernateDAO<Shelving> implements java.io.Serializable, ShelvingDAO {
    ...
    @Override
    public void update(final Shelving Shelving) {
        Session s = null;
        Transaction tx = null;
        try {
    ...
    @Override
    public List<Shelving> findById(final Integer ID) {
    ...
    @Override
    public int count() {
        final Session session = HibernateSQLServerUtil.getSessionFactory().openSession();
        try {
